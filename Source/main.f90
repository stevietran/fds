...
INTEGER, ALLOCATABLE, DIMENSION(:) :: REQ,REQ1,REQ2,REQ3,REQ4,REQ5,REQ7,REQ6,REQ8,COUNTS,DISPLS,&
                                      ...
                                      COUNTS_QM_DOT,DISPLS_QM_DOT,COUNTS_EIGHT,DISPLS_EIGHT
...
SELECT CASE(TASK_NUMBER)
   ...
   CASE(1)
      ...
      ALLOCATE(REAL_BUFFER_2(8,NMESHES))
      ALLOCATE(REAL_BUFFER_3(8,NMESHES))
      ...
      ALLOCATE(COUNTS_EIGHT(0:N_MPI_PROCESSES-1))
      ...
      ALLOCATE(DISPLS_EIGHT(0:N_MPI_PROCESSES-1))
      ...
      COUNTS_EIGHT  = COUNTS*8
      DISPLS_EIGHT  = DISPLS*8
...
PRESSURE_ITERATION_LOOP: DO
   ...
   IF (N_MPI_PROCESSES>1) THEN
      ...
      CALL MPI_ALLGATHERV(REAL_BUFFER_2(1,DISPLS(MYID)+1),COUNTS_EIGHT(MYID),MPI_DOUBLE_PRECISION, &
                          REAL_BUFFER_3,COUNTS_EIGHT,DISPLS_EIGHT,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,IERR)
